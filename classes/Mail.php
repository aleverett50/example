...
class Mail {
			...
			public static function emailFooter(){
					...
					return "<br /><br /><br /><br />Thanks<br /><br />".COMPANY_NAME." <br /><br />Phone:<br />General enquiries: <a href='mailto:info@'>info@</a><br />Returns enquiries: <a href='mailto:returns@'>returns@</a><br /><div style='float:left;width:100%;height:3px; background:".MAIN_COLOUR.";margin-top:20px'></div></div>";
